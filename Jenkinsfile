...
class DockerParameters {
    ...
    def args = '--device /dev/kvm:/dev/kvm -v /var/local/container_shared/gradle_cache/$EXECUTOR_NUMBER:/home/user/.gradle -v /var/local/container_shared/huawei:/home/user/huawei'
                ...
                stage('1') {
                    ...
                    stages {
                        ...
                        stage('Unit Tests') {
                            steps {
                                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {                                   
                                    sh """./gradlew ${debugUnitTests()} -PenableCoverage jacocoTestCatroidDebugUnitTestReport --full-stacktrace -Pemulator=31"""
